...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Mingrand - Modern Real Estate HTML template.</title>
        <!-- Stylesheets -->
    ...
    <body>
        ...
        <div class="page-wrapper">
            ...
            <aside id="sidebar">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#folder-structure"
                                    >Folder Structure <span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#banner-area"
                                    >Banner<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                                <a href="#blog-area"
                                    >Blog<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                                <a href="#signin-area"
                            ...
                            <li>
                                <a href="#404-area"
                                    >404<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                                <a href="#contact-area"
                                    >Contact<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                                <a href="#sidebar-area"
                                    >Sidebar<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                                <a href="#widget-area"
                                    >Widget<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                                <a href="#footer-area"
                                    >Footer<span class="fa fa-arrow-right"></span
                                ></a>
                            </li>
                            <li>
                ...
                <div class="copyright">Copyright &copy; <a href="#">Mingrand</a> 2021</div>
            </aside>
            ...
            <div id="content-section">
                ...
                <section class="section introduction" id="introduction">
                    ...
                    <div class="sec-content">
                        <h2>Mingrand</h2>
                        <h3>Mingrand - Modern Real Estate HTML template.</h3>

                        <div class="separator"></div>

                        <strong>Created :</strong> 4/1/2021<br />
                        <strong>By :</strong> solverwp<br />
                        <strong>E-mail:</strong> solverwp21@gmail.com <br>
                        <strong>Last Update :</strong> 4/14/2021<br />
                        <strong>Version :</strong> 1.0.3<br />

                        <br />
                        <p>
                            Thank you for purchasing <strong>Mingrand</strong> - Modern Real Estate HTML template. 
                ...
                <section class="section introduction" id="folder-structure">
                    <div class="sec-title">
    ...
    <code>HTML
      ...
      └── all html files
                ...
                <section class="section html-structure" id="html-structure">
                    ...
                    <div class="sec-content">
                        <h3>
                            The html template uses Latest <strong>Bootstrap 4</strong> with valid
                ...
                <section class="section map-settings" id="logo-area">
                    ...
                    <div class="sec-content">
                        <div class="html-code">
                            <img src="images/logo-html.png" alt="image html"/>
                        </div>
                    </div>
                </section>

                <!--Banner Structure-->
                <section class="section map-settings" id="banner-area">
                    <div class="sec-title">
                    ...
                    <div class="sec-content">
                        ...
                        <br>
                        <div class="html-code">
                            <img src="images/banner.png" alt="image html"/>
                        </div>
                    </div>
                </section>
                ...
                <!--Blog Structure-->
                <section class="section map-settings" id="signin-area">
                    <div class="sec-title">
                        <h2>Sign In Structure</h2>
                    </div>

                    <br />
                    <div class="sec-content">
                        <div class="html-code">
                            <img src="images/signin.jpg" alt="image html"/>
                        </div>
                    </div>
                </section>

                <!--Blog Structure-->
                <section class="section map-settings" id="404-area">
                    <div class="sec-title">
                        <h2>404 Structure</h2>
                    </div>
                    ...
                    <div class="sec-content">
                        <div class="html-code">
                            <img src="images/404.jpg" alt="image html"/>
                        </div>
                    </div>
                </section>

                <!--Contact Structure-->
                <section class="section map-settings" id="contact-area">
                    <div class="sec-title">
                        <h2>Contact Structure</h2>
                    </div>

                    <br />
                    <div class="sec-content">
                        <div class="html-code">
                            <img src="images/contact-2.png" alt="image html"/>
                        </div>
                        <br>
                    </div>
                </section>
                ...
                <!--Sidebar Structure-->
                <section class="section map-settings" id="sidebar-area">
                    <div class="sec-title">
                    ...
                    <div class="sec-content">
                        <div class="html-code">
                            <img src="images/sidebar.png" alt="image html"/>
                        </div>
                    </div>
                </section>

                <!--Widget Structure-->
                <section class="section map-settings" id="widget-area">
                    <div class="sec-title">
                    ...
                    <div class="sec-content">
                        <div class="html-code">
                            <img src="images/widget.png" alt="image html"/>
                        </div>
                    </div>
                </section>
                ...
                <section class="section sources-credits" id="Feature-card">
                    ...
                    <div class="sec-content">
                        <ul>
                            <li><strong>4 Awesome Multi-Homepages</strong></li>
                            <li><strong>3 Awesome Header Styles</strong></li>
                            <li><strong>Google map search option</strong></li>
                            <li><strong>Sticky Header Styles</strong></li>
                            <li>W3C validated code</li>
                            <li>SASS File Included</li>
                            <li>16 inner pages</li>
                            <li>60+ Unique Element</li>
                            <li>Blog Standard Layout</li>
                            <li>Property Standard Layout</li>
                            <li>Signin / signup Pages</li>
                ...
                <section class="section sources-credits" id="sources-credits">
                    ...
                    <div class="sec-content">
                        ...
                        <p>
                            Owl Carousel (
                            <a href="https://owlcarousel2.github.io/OwlCarousel2/demos/demos.html">Owl Carousel</a> )
                        </p>
                        <br />
                ...
                <section class="section support" id="support">
                    ...
                    <div class="sec-content">
                        <h3>
                            ...
                            you have any queries, please feel free to contact us at 
                            <br>
                            <br>
                            <strong>solverwp21@gmail.com</strong>
                        </h3>

                        <p>Email Us at : <a href="mailto:solverwp21@gmail.com">Mingrand</a></p>
                    </div>
                </section>
            </div>
        </div>
